...
pythia = [
    ...
    dict(
        name="pythia-14m-linear",
        hf_config=dict(org="EleutherAI", name="pythia-14m-linear"),
        block_size=4096,
        n_layer=6,
        n_embd=128,
        n_head=4,
    ...
    dict(
        name="pythia-410m-linear",
        hf_config=dict(org="EleutherAI", name="pythia-410m-linear"),
        # block_size=4096,
        block_size=4096,
        n_layer=24,
        n_embd=1024,
